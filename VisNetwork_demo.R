...
## ------------------------------------------------------------------------
visNetwork(nodes, edges, width = "100%") %>% visLegend(main="Legend", position="right", ncol=1)
...
##################################Image and icon######
path_to_images <-
  "https://raw.githubusercontent.com/datastorm-open/datastorm-open.github.io/master/visNetwork/data/img/indonesia/"
